...
//
//    @Transactional
//    public Basket save(BasketRequestDto dto) {
//        log.info("SAVE basket: clientId={}, productId={}, quantity={}",
//                dto.getClientId(), dto.getProductId(), dto.getQuantity());
//
//        try {
//            Basket basket = new Basket(dto, customerService, productService);
//            Basket saved = basketRepo.save(basket);
//            log.info("SAVE OK: basketId={}", saved.getId());
//            return saved;
//        } catch (Exception e) {
//            log.error("SAVE FAILED: clientId={}, productId={}, error={}",
//                    dto.getClientId(), dto.getProductId(), e.getMessage(), e);
//            throw e;
//        }
//    }
//
...
//
//    @Transactional
//    public Optional<Basket> merge(long id, BasketRequestDto dto) {
//        log.info("MERGE basket: id={}, quantity={}", id, dto.getQuantity());
//
